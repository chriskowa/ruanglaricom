...
<head>
  ...
  <title>RUNNING ROUTE CREATOR​ - Ruang Lari</title>
  ...
  <meta property="og:title" content="RUNNING ROUTE CREATOR​" class="yoast-seo-meta-tag" />
  ...
  <script type="application/ld+json" class="yoast-schema-graph">
    {
      ...
      "@graph": [{
        ...
        "name": "RUNNING ROUTE CREATOR​ - Ruang Lari",
        "isPartOf": {
    ...
    <div class="rungo-wrapper">
      <div class="app">
        ...
        <section class="hint" style="display: none;">
          <span class="pill">💡 Klik di peta untuk menambah titik rute (muncul marker).</span>
          <span class="pill">🛣 "Ikuti jalan" supaya rute ngikut jalan (jalan kaki/lari).</span>
          <span class="pill">↩ Undo / Redo untuk langkah terakhir.</span>
          <span class="pill">🔍 Gunakan kotak pencarian untuk lompat ke kota/lokasi tertentu.</span>
        </section>
      </div>

      <section class="panel" id="strava-form-panel">
          ...
          <div class="modal-content">
            <div class="modal-body" style="font-size:0.95rem;">
              <div class="d-flex flex-column" style="gap:8px;">
                <div>💡 Klik di peta untuk menambah titik rute (muncul marker).</div>
                <div>🛣 "Ikuti jalan" supaya rute ngikut jalan (jalan kaki/lari).</div>
                <div>↩ Undo / Redo untuk langkah terakhir.</div>
                <div>🔍 Gunakan kotak pencarian untuk lompat ke kota/lokasi tertentu.</div>
              </div>
            </div>
