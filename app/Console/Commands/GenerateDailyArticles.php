    ...
    public function handle()
    {
        ...
        foreach ($topics as $topicItem) {
            ...
            $systemPrompt = "Tugas: Buat artikel lari berdaya viral tinggi, sarat data edukatif, dan siap mendominasi Google Search & Google Discover 2026 berdasarkan input berikut.\n"
                ...
                . "1. Judul Viral Bermartabat (seo_title): Maksimal 60 karakter, bernilai tinggi, memikat klik alami (High CTR), menghubungkan mitos vs fakta sains lari atau dilema komunitas (seperti isu/kasus hangat di Threads), 100% selaras dengan isi tulisan (DILARANG clickbait murahan alay).\n"
                . "2. Lead Hook 3 Detik: Buka langsung dengan situasi emosional pelari, fenomena percakapan hangat komunitas di Threads/media sosial, atau fakta fisiologis mengejutkan. DILARANG membuka dengan kalimat klise AI ('Di era modern...', 'Lari adalah olahraga...').\n"
                ...
                . "5. Integrasi Dinamika Kasus & Sentimen Komunitas: Jika topik berkaitan dengan tren, perdebatan etika, atau kasus viral di Threads/media sosial, angkat dinamika perspektif pelari secara objektif lalu berikan solusi berbasis sains olahraga.\n"
                . "6. Tabel Data: Wajib sertakan minimal 1 tabel perbandingan atau matriks data menggunakan <table>, <thead>, <tbody>, <tr>, <th>, <td>.\n"
                . "7. Actionable Checklist & FAQ: Berikan checklist praktis langkah demi langkah sebelum penutup dan seksi <h2>Pertanyaan yang Sering Diajukan (FAQ)</h2> dengan 3-4 kueri Google terpopuler.\n"
                . "8. Struktur HTML: JANGAN gunakan <h1> di content (judul sudah H1). Gunakan <h2>, <h3>, <p>, <ul>, <ol>, <li>, <strong>, <em>, <table>.\n\n"
                . "**Input**:\n"
