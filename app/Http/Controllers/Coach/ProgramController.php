...
class ProgramController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'pricing_model' => 'nullable|in:one_time,hourly,daily,weekly,monthly,custom_package',
            'price_hourly' => 'nullable|numeric|min:0',
            'price_daily' => 'nullable|numeric|min:0',
            'price_weekly' => 'nullable|numeric|min:0',
            'price_monthly' => 'nullable|numeric|min:0',
            'session_quota' => 'nullable|integer|min:1',
            'allow_manual_payment' => 'nullable|boolean',
