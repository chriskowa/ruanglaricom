...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'price' => 'required_if:sale_type,fixed|numeric|min:0',
            'stock' => 'required_if:sale_type,fixed|integer|min:1',
            'starting_price' => 'required_if:sale_type,auction|numeric|min:0',
            'min_increment' => 'required_if:sale_type,auction|numeric|min:0',
            'auction_end_at' => 'required_if:sale_type,auction|date|after:now',
