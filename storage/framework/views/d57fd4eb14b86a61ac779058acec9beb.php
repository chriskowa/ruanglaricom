...
<head>
    ...
    <script>
        ...
        window.phGaId = <?php echo json_encode($ga, 15, 512) ?>;
        <?php endif; ?>
        <?php if($gads): ?>
        gtag('config', '<?php echo e($gads); ?>');
        window.phGadsId = <?php echo json_encode($gads, 15, 512) ?>;
        <?php endif; ?>
    </script>
    <?php endif; ?>
    ...
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('meta_title', $defaultTitle); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('meta_description', $defaultDesc); ?>">
    ...
    <script>
        window.recaptchaSiteKey = <?php echo json_encode($recaptchaSiteKeyV3, 15, 512) ?>;
...
<body class="<?php echo e(isset($lightMode) && $lightMode ? 'bg-slate-50 text-slate-900' : 'bg-dark text-white'); ?> font-sans antialiased flex flex-col min-h-screen">
    ...
    <script>
        (function() {
            var gaId = window.phGaId || window.phGadsId;
            if (!gaId) return;
