    ...
    function authModalComponent() {
        return {
            ...
            async requestOtp() {
                ...
                try {
                    const response = await fetch('<?php echo e(route('login.phone.request')); ?>', {
                        method: 'POST',
                        headers: {
            ...
            async verifyOtp() {
                ...
                try {
                    const response = await fetch('<?php echo e(route('login.phone.verify')); ?>', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
            ...
            async submitLogin(e) {
                ...
                const recaptchaKeyV3 = '<?php echo e(env('RECAPTCHA_SITE_KEY_v3') ?: env('RECAPTCHA_SITE_KEY')); ?>';
                ...
                try {
                    const res = await fetch('<?php echo e(route('login')); ?>', {
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                            'Accept': 'application/json'
            ...
            async submitRegister(e) {
                ...
                try {
                    const res = await fetch('<?php echo e(route('register')); ?>', {
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                            'Accept': 'application/json'
...
<?php /**PATH C:\laragon\www\ruanglari\resources\views/layouts/components/auth-modal.blade.php ENDPATH**/ ?>