            ...
            <div class="max-w-7xl mx-auto p-5">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    <div class="col-span-1 md:col-span-1">
                        <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2 mb-6 group">
                            <img src="<?php echo e(asset('images/logo saja ruang lari.png')); ?>" alt="<?php echo e($siteTitle); ?>" class="h-8 w-auto group-hover:scale-110 transition duration-300">
                        ...
                        <div class="flex gap-4">
                            <?php if($socialInsta): ?>
                            <a href="<?php echo e($socialInsta); ?>" target="_blank" class="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center text-slate-400 hover:bg-neon hover:text-slate-900 transition"><i class="fab fa-instagram"></i></a>
                            <?php endif; ?>
                            <?php if($socialTiktok): ?>
                            <a href="<?php echo e($socialTiktok); ?>" target="_blank" class="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center text-slate-400 hover:bg-neon hover:text-slate-900 transition"><i class="fab fa-tiktok"></i></a>
                            <?php endif; ?>
                            <?php if($socialFb): ?>
                            <a href="<?php echo e($socialFb); ?>" target="_blank" class="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center text-slate-400 hover:bg-neon hover:text-slate-900 transition"><i class="fab fa-facebook-f"></i></a>
                            <?php endif; ?>
                            <?php if($socialYt): ?>
                            <a href="<?php echo e($socialYt); ?>" target="_blank" class="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center text-slate-400 hover:bg-neon hover:text-slate-900 transition"><i class="fab fa-youtube"></i></a>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-slate-400 text-sm font-medium">
                            <li><a href="<?php echo e(route('pacer.index')); ?>" class="hover:text-white hover:translate-x-1 inline-block transition">Cari Pacer</a></li>
                            <li><a href="<?php echo e(route('events.index')); ?>" class="hover:text-white hover:translate-x-1 inline-block transition">Event Kalender</a></li>
                            <li><a href="<?php echo e(route('leaderboard.cyberpunk')); ?>" class="hover:text-white hover:translate-x-1 inline-block transition">Leaderboard</a></li>
                            <li><a href="<?php echo e(route('programs.realistic')); ?>" class="hover:text-white hover:translate-x-1 inline-block transition">Running Calculator</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-slate-400 text-sm font-medium">
                            <li><a href="<?php echo e(route('home')); ?>#about" class="hover:text-white hover:translate-x-1 inline-block transition">Tentang Kami</a></li>
                            <li><a href="<?php echo e(route('pacer.register')); ?>" class="hover:text-white hover:translate-x-1 inline-block transition">Menjadi Pacer</a></li>
                            <li><a href="https://ruanglari.com/blog" class="hover:text-white hover:translate-x-1 inline-block transition">Blog & Tips</a></li>
                            <li><a href="<?php echo e(route('home')); ?>#faq" class="hover:text-white hover:translate-x-1 inline-block transition">FaQ</a></li>
                        </ul>
                    </div>
                ...
                <div class="border-t border-slate-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-600 font-medium">
                    <p>&copy; <?php echo e(date('Y')); ?> RuangLari Indonesia. All rights reserved.</p>
