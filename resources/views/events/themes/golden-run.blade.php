...
<head>
                ...
                extend: {
                    colors: {
                        brand: {
                            ...
                            200: '#fde68a',
                            300: '#fcd34d',
                            400: '#fbbf24', // Primary Gold Light
                            500: '#f59e0b', // Primary Gold
                            600: '#d97706', // Primary Gold Dark
                            700: '#b45309',
                            800: '#92400e',
                            900: '#78350f',
                        },
                    ...
                    boxShadow: {
                        ...
                        'card': '0 0 0 1px rgba(255,255,255,0.1), 0 4px 20px rgba(0,0,0,0.5)',
                    },
                    animation: {
    ...
    <style>
        ...
        /* Sticky Navigation */
        .nav-scrolled { background-color: rgba(9, 9, 11, 0.9); backdrop-filter: blur(10px); box-shadow: 0 4px 20px -5px rgba(0, 0, 0, 0.5); border-bottom: 1px solid rgba(255,255,255,0.1); }
        .nav-scrolled .nav-link { color: #cbd5e1 !important; }
        .nav-scrolled .nav-link:hover { color: #fbbf24 !important; }
        .nav-scrolled .nav-brand { color: #ffffff !important; }
        .nav-scrolled .mobile-toggle { color: #ffffff !important; }
    ...
    <style>
        ...
        /* ==========================================
           ...
           ========================================== */
        body.theme-light {
            background-color: #f8fafc !important; /* Latar belakang abu-abu sangat muda */
            color: #334155 !important;
        }

        /* 1. Background Mapping */
        .theme-light .bg-dark-950 { background-color: #ffffff !important; }
        .theme-light .bg-dark-900 { background-color: #f1f5f9 !important; }
        .theme-light .bg-dark-800 { 
            background-color: #ffffff !important; 
            border-color: #cbd5e1 !important;
        }

        /* 2. Cards & Containers (Ubah efek glassmorphism gelap jadi solid putih + shadow) */
        ...
        /* 4. Text Colors (Dipergelap agar kontras di background putih) */
        .theme-light .text-white { color: #0f172a !important; }
        .theme-light .text-slate-300 { color: #334155 !important; } /* Teks paragraf/label */
        .theme-light .text-slate-400 { color: #475569 !important; } /* Teks sub-judul */
        .theme-light .text-slate-500 { color: #64748b !important; } /* Teks info kecil */
        
        .theme-light .text-brand-400 { color: #d97706 !important; /* brand-600 */ }
        .theme-light .text-brand-300 { color: #b45309 !important; /* brand-700 */ }

        /* 5. Form Inputs (Sangat penting agar input tidak gelap di light mode) */
        .theme-light input, 
        .theme-light select, 
        .theme-light textarea {
            ...
            color-scheme: light !important; /* Mengubah icon kalender jadi hitam */
        }
        ...
        .theme-light textarea:focus {
            border-color: #d97706 !important; /* Fokus warna gold */
        ...
        .theme-light #navbar .nav-brand,
        .theme-light #navbar .mobile-toggle {
             color: #0f172a !important; 
        }
        ...
        /* 7. Hero Overlays (Transisi putih yang lebih lembut) */
        .theme-light .hero-overlay-v {
            background: linear-gradient(to top, rgba(255, 255, 255, 1) 0%, rgba(255, 255, 255, 0.85) 30%, rgba(255, 255, 255, 0.2) 75%, transparent 100%) !important;
        }
        .theme-light .hero-overlay-h {
            background: linear-gradient(to right, rgba(255, 255, 255, 1) 0%, rgba(255, 255, 255, 0.9) 30%, rgba(255, 255, 255, 0.3) 60%, transparent 100%) !important;
        }

        /* 8. Hero Title (Golden Gradient High Contrast) */
        .theme-light h1 .bg-clip-text {
            /* Warna emas dibuat lebih tua (cokelat emas) agar terlihat jelas di atas background terang */
            background-image: linear-gradient(180deg, #b45309 0%, #f59e0b 50%, #78350f 100%) !important;
...
<body class="antialiased flex flex-col min-h-screen">
    ...
    <div class="fixed inset-0 z-[100] bg-dark-950 overflow-y-auto overflow-x-hidden custom-scrollbar">
        <!-- Background -->
        <div class="fixed inset-0 z-0 pointer-events-none">
            ...
            @endif
            <div class="absolute inset-0 bg-gradient-to-b from-dark-950/50 via-dark-950/90 to-dark-950"></div>
        </div>
        ...
        <div class="relative z-10 min-h-screen flex flex-col items-center justify-center py-12 px-4 md:px-6 text-center">
            ...
            <div class="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-8 animate-fade-in-up delay-100 shadow-lg hover:bg-white/10 transition">
                <span class="relative flex h-2.5 w-2.5">
                  ...
                  <span class="relative inline-flex rounded-full h-2.5 w-2.5 bg-accent-600"></span>
                </span>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <button id="themeToggleDesktop" class="p-2 rounded-full hover:bg-white/10 transition text-white/90 hover:text-white" aria-label="Toggle Theme">
                        <i class="fas fa-sun"></i>
                    </button>

                    @if($isRegOpen)
                        <a href="#register" class="bg-gradient-to-r from-brand-400 to-brand-600 text-black px-6 py-2.5 rounded-full text-sm font-bold shadow-lg shadow-brand-500/20 hover:shadow-brand-500/40 hover:-translate-y-0.5 transition-all duration-300">
                            Daftar Sekarang
                        </a>
                    @else
            ...
            <div id="mobileMenu" class="hidden md:hidden bg-dark-900 border-t border-white/10 absolute inset-x-0 left-0 px-4 py-4 space-y-4 shadow-xl rounded-b-2xl">
                <a href="#about" class="block text-slate-300 font-medium p-2 hover:bg-white/5 hover:text-white rounded-lg transition">Tentang</a>
                <a href="#categories" class="block text-slate-300 font-medium p-2 hover:bg-white/5 hover:text-white rounded-lg transition">Kategori</a>
                <a href="#venue" class="block text-slate-300 font-medium p-2 hover:bg-white/5 hover:text-white rounded-lg transition">Lokasi</a>
                <a href="#racepack" class="block text-slate-300 font-medium p-2 hover:bg-white/5 hover:text-white rounded-lg transition">Race Pack</a>
                <a href="#info" class="block text-slate-300 font-medium p-2 hover:bg-white/5 hover:text-white rounded-lg transition">Info Event</a>
                @if(($hasPaidParticipants ?? false) && $event->show_participant_list)
                    <a href="#participants-list" class="block text-slate-300 font-medium p-2 hover:bg-white/5 hover:text-white rounded-lg transition">Daftar Peserta</a>
                @endif
    ...
    <header id="top" class="relative pt-24 pb-12 overflow-hidden bg-dark-950 min-h-[85vh] flex items-center">
        <!-- Dynamic Background -->
            ...
            <div class="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
                <div class="flex-1 text-center md:text-left reveal active">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start mb-12">
                        @if($isRegOpen)
                        <a href="#register" class="group px-8 py-4 bg-gradient-to-r from-brand-400 to-brand-600 text-black font-bold rounded-2xl shadow-lg shadow-brand-500/30 hover:shadow-brand-500/50 transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-2">
                            Amankan Slot
                ...
                <div class="flex-1 w-full max-w-md mx-auto reveal delay-200 hidden lg:block">
                    <div class="bg-white/5 backdrop-blur-xl p-8 rounded-[2.5rem] border border-white/10 shadow-2xl animate-float">
                        <div class="flex justify-between items-start mb-8">
                            <div>
                                <p class="text-xs text-brand-400 font-bold uppercase tracking-wider mb-1">EVENT STATUS</p>
                                <p class="text-3xl font-black text-white">READY TO RACE</p>
                            </div>
                            <div class="w-14 h-14 bg-brand-500 rounded-2xl flex items-center justify-center text-black shadow-lg shadow-brand-500/40">
                        ...
                        <div class="space-y-4">
                            <div class="bg-dark-950/50 p-5 rounded-2xl border border-white/5 flex items-center gap-4">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative reveal delay-200">
                    <div class="absolute -top-10 -right-10 w-64 h-64 bg-brand-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
    ...
    <section id="gallery" class="py-24 bg-dark-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12 reveal">
                <span class="text-brand-400 font-bold uppercase tracking-widest text-sm">Dokumentasi</span>
    ...
    <section id="categories" class="py-24 bg-dark-950">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 {{ $gridClass }}">
                ...
                @endphp
                <div class="relative flex flex-col bg-dark-900 rounded-[2rem] border border-white/10 shadow-card hover:shadow-glow hover:-translate-y-2 transition-all duration-300 group reveal overflow-hidden">
                    <div class="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-brand-400 to-brand-600"></div>
                    
                    <div class="p-8 flex-1">
                        <div class="flex justify-between items-start mb-6">
                            <span class="inline-flex items-center px-4 py-2 rounded-xl text-lg font-black bg-white/5 text-white border border-white/10">
                                {{ $cat->distance_km ?? '?' }}K
                            </span>
                            @if($cat->quota < 50 && $cat->quota > 0)
                                <span class="px-3 py-1 rounded-full bg-accent-500/20 text-accent-400 text-xs font-bold animate-pulse">
                                    🔥 Sisa Sedikit
                                </span>
                            @endif
                        </div>
                    ...
                    <div class="p-6 bg-white/5 border-t border-white/10">
                        <div class="flex items-baseline justify-between mb-4">
                            ...
                            <div class="text-right">
                                ...
                                @endif
                                <div class="text-3xl font-black text-brand-400">Rp {{ number_format($displayPrice/1000, 0) }}k</div>
                            </div>
                        </div>
                        <a href="#register" class="block w-full py-4 px-4 bg-gradient-to-r from-brand-400 to-brand-600 text-black font-bold text-center rounded-xl shadow-lg shadow-brand-500/20 hover:shadow-brand-500/40 transition-all duration-300">
                            Daftar Sekarang
                        </a>
                    </div>
                </div>
    ...
    <section id="routes" class="py-24 bg-dark-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal">
                <span class="text-brand-400 font-bold uppercase tracking-widest text-sm">Race Course</span>
                <h2 class="text-3xl font-extrabold text-white sm:text-4xl mt-2">Peta Rute</h2>
                <p class="text-slate-400 mt-4 max-w-2xl mx-auto">Jelajahi rute lari untuk setiap kategori. Klik tab kategori untuk melihat detail rute dan elevasi.</p>
                <div class="mt-6 flex justify-center">
                    <button type="button" id="openPredictorBtn" class="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-brand-500 text-black font-bold shadow-lg shadow-brand-500/20 hover:bg-brand-400 transition">
                        Prediksi Waktu
            ...
            <div id="predictorModal" class="fixed inset-0 z-[70] hidden">
                ...
                <div class="relative h-full w-full flex items-center justify-center p-4">
                    <div class="w-full max-w-4xl bg-dark-900 rounded-3xl shadow-2xl border border-white/10 overflow-hidden">
                        <div class="flex items-start justify-between gap-4 p-6 border-b border-white/10">
                            <div>
                                <div class="text-xs font-bold text-slate-400 uppercase tracking-wider">Prediksi Waktu</div>
                                <div class="text-2xl font-black text-white">{{ $event->name }}</div>
                                <a href="{{ route('events.prediction', $event->slug) }}" class="inline-block mt-1 text-sm font-semibold text-brand-400 hover:text-brand-300">
                                    Buka Halaman Penuh →
                                </a>
                            </div>
                            <button type="button" id="closePredictorBtn" class="p-2 rounded-xl hover:bg-white/5 text-slate-400">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                <div class="lg:col-span-1">
                                    <div class="bg-white/5 border border-white/10 rounded-2xl p-5">
                                        <div class="text-lg font-black text-white">Input</div>

                                        <div class="mt-4">
                                            <label class="text-xs font-bold text-slate-400 uppercase tracking-wider">Kategori</label>
                                            <select id="predictCategory" class="mt-2 w-full bg-dark-800 border border-white/10 rounded-xl px-4 py-3 text-white font-semibold focus:ring-2 focus:ring-brand-500 outline-none">
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="mt-2 grid grid-cols-2 gap-2">
                                                <label class="cursor-pointer">
                                                    ...
                                                    <div class="px-4 py-3 rounded-xl border border-white/10 bg-dark-800 peer-checked:border-yellow-500 peer-checked:bg-yellow-500/20 font-bold text-white transition">Cerah</div>
                                                </label>
                                                <label class="cursor-pointer">
                                                    <input type="radio" name="predictWeather" value="dingin" class="peer sr-only">
                                                    <div class="px-4 py-3 rounded-xl border border-white/10 bg-dark-800 peer-checked:border-cyan-500 peer-checked:bg-cyan-500/20 font-bold text-white transition">Dingin</div>
                                                </label>
                                                <label class="cursor-pointer">
                                                    <input type="radio" name="predictWeather" value="hujan" class="peer sr-only">
                                                    <div class="px-4 py-3 rounded-xl border border-white/10 bg-dark-800 peer-checked:border-blue-500 peer-checked:bg-blue-500/20 font-bold text-white transition">Hujan</div>
                                                </label>
                                                <label class="cursor-pointer">
                                                    <input type="radio" name="predictWeather" value="gerimis" class="peer sr-only">
                                                    <div class="px-4 py-3 rounded-xl border border-white/10 bg-dark-800 peer-checked:border-sky-500 peer-checked:bg-sky-500/20 font-bold text-white transition">Gerimis</div>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="mt-2 grid grid-cols-3 gap-2">
                                                <input id="predictPbH" type="number" min="0" max="23" value="0" class="bg-dark-800 border border-white/10 rounded-xl px-3 py-3 text-white font-semibold focus:ring-2 focus:ring-brand-500 outline-none" placeholder="Jam">
                                                <input id="predictPbM" type="number" min="0" max="59" value="0" class="bg-dark-800 border border-white/10 rounded-xl px-3 py-3 text-white font-semibold focus:ring-2 focus:ring-brand-500 outline-none" placeholder="Menit">
                                                <input id="predictPbS" type="number" min="0" max="59" value="0" class="bg-dark-800 border border-white/10 rounded-xl px-3 py-3 text-white font-semibold focus:ring-2 focus:ring-brand-500 outline-none" placeholder="Detik">
                                            </div>
                                        </div>

                                        <div class="mt-5">
                                            <label class="text-xs font-bold text-slate-400 uppercase tracking-wider">Tanggal PB (3 bulan terakhir)</label>
                                            <input id="predictPbDate" type="date" class="mt-2 w-full bg-dark-800 border border-white/10 rounded-xl px-4 py-3 text-white font-semibold focus:ring-2 focus:ring-brand-500 outline-none" style="color-scheme: dark;">
                                        </div>

                                        <p id="predictModalError" class="mt-4 text-red-500 text-sm hidden"></p>

                                        <button id="predictModalBtn" type="button" class="mt-5 w-full px-5 py-3 rounded-xl bg-brand-500 hover:bg-brand-400 text-black font-black transition shadow-lg shadow-brand-500/20">
                                            Prediksi Waktu
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="lg:col-span-2 space-y-6">
                                    <div class="bg-white/5 border border-white/10 rounded-2xl p-5">
                                        <div class="text-lg font-black text-white">Hasil Prediksi</div>
                                        ...
                                        <div id="predictResultWrap" class="mt-4 hidden">
                                            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                                <div class="bg-dark-800 border border-white/10 rounded-xl p-4">
                                                    ...
                                                    <div class="text-white font-black mt-1 text-2xl" id="predictOptimistic">-</div>
                                                </div>
                                                <div class="bg-dark-800 border border-white/10 rounded-xl p-4">
                                                    <div class="text-slate-400 text-xs font-bold uppercase">Realistis</div>
                                                    <div class="text-white font-black mt-1 text-2xl" id="predictRealistic">-</div>
                                                </div>
                                                <div class="bg-dark-800 border border-white/10 rounded-xl p-4">
                                                    <div class="text-slate-400 text-xs font-bold uppercase">Pesimis</div>
                                                    <div class="text-white font-black mt-1 text-2xl" id="predictPessimistic">-</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                                                <div class="bg-dark-800 border border-white/10 rounded-xl p-4">
                                                    ...
                                                    <div class="text-white font-black mt-1" id="predictConfidence">-</div>
                                                </div>
                                                <div class="bg-dark-800 border border-white/10 rounded-xl p-4">
                                                    <div class="text-slate-400 text-xs font-bold uppercase">Jarak Rute</div>
                                                    <div class="text-white font-black mt-1" id="predictRouteDistance">-</div>
                                                </div>
                                                <div class="bg-dark-800 border border-white/10 rounded-xl p-4">
                                                    <div class="text-slate-400 text-xs font-bold uppercase">Elev Gain</div>
                                                    <div class="text-white font-black mt-1" id="predictRouteGain">-</div>
                                                </div>
                                            </div>

                                            <div class="mt-4 bg-dark-800 border border-white/10 rounded-xl p-4">
                                                <div class="text-slate-400 text-xs font-bold uppercase">Strategi</div>
                                                <div class="text-slate-200 font-semibold mt-2 leading-relaxed" id="predictStrategy">-</div>
                                            </div>
                                        </div>
            ...
            <div x-data="{ activeTab: '{{ $categoriesWithGpx->first()->id }}' }">
                ...
                <div class="flex flex-wrap justify-center gap-4 mb-8">
                    @foreach($categoriesWithGpx as $category)
                        <button 
                            ...
                            :class="activeTab === '{{ $category->id }}' ? 'bg-brand-500 text-black shadow-lg shadow-brand-500/30' : 'bg-white/5 text-slate-400 hover:bg-white/10'"
                ...
                <!-- Maps -->
                <div class="relative bg-dark-800 rounded-3xl overflow-hidden border border-white/10 shadow-inner h-[500px]">
                    @foreach($categoriesWithGpx as $category)
                        <div x-show="activeTab === '{{ $category->id }}'" 
                            ...
                            <!-- Stats Overlay -->
                            <div class="absolute top-4 left-4 bg-dark-900/90 backdrop-blur-md p-4 rounded-2xl shadow-lg border border-white/10 z-20 max-w-xs">
                                <h4 class="font-bold text-white mb-2">{{ $category->name }}</h4>
                                <div class="grid grid-cols-2 gap-4 text-xs">
                                    <div>
                                        <span class="block text-slate-400">Distance</span>
                                        <span class="block font-bold text-white text-lg">{{ $category->masterGpx->distance_km }} KM</span>
                                    </div>
                                    <div>
                                        <span class="block text-slate-400">Elev. Gain</span>
                                        <span class="block font-bold text-white text-lg">{{ $category->masterGpx->elevation_gain_m }} m</span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section id="medal" class="py-24 bg-dark-950 relative overflow-hidden">
    ...
    <section id="racepack" class="py-24 bg-dark-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                <!-- Jersey Card -->
                <div class="bg-white/5 rounded-[2.5rem] p-8 shadow-xl border border-white/10 overflow-hidden relative group reveal">
                    <div class="absolute top-0 right-0 w-64 h-64 bg-brand-500/10 rounded-full -mr-16 -mt-16 transition group-hover:scale-110"></div>
                    <div class="relative z-10">
                        <div class="flex items-center gap-4 mb-6">
                            <div class="w-12 h-12 bg-brand-500/20 rounded-2xl flex items-center justify-center text-brand-400">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="bg-white/5 p-8 rounded-3xl shadow-sm border border-white/10 flex items-start gap-6 hover:shadow-md transition reveal delay-200">
                        ...
                        <div class="flex-1">
                            <h4 class="text-xl font-bold text-white mb-4">Dokumen & Administrasi Peserta</h4>
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <a href="https://res.cloudinary.com/dslfarxct/raw/upload/v1769990790/Surat-Izin-Orang-Tua_k4iavi.docx" class="group flex items-center gap-3 p-3 rounded-xl bg-dark-800 hover:bg-dark-700 border border-white/10 hover:border-brand-500/30 transition-all">
                                    <div class="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center text-slate-400 group-hover:text-brand-400 shadow-sm shrink-0">
                                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
                                    </div>
                                    <div>
                                        <div class="text-sm font-bold text-slate-300 group-hover:text-white leading-tight">Surat Izin Orang Tua</div>
                                        <div class="text-[10px] text-slate-500 group-hover:text-brand-400 mt-0.5">Download .docx</div>
                                    </div>
                                </a>
                                <a href="https://res.cloudinary.com/dslfarxct/raw/upload/v1769990790/Surat-Kuasa-Paolorunfest_thhu6w.docx" class="group flex items-center gap-3 p-3 rounded-xl bg-dark-800 hover:bg-dark-700 border border-white/10 hover:border-brand-500/30 transition-all">
                                    <div class="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center text-slate-400 group-hover:text-brand-400 shadow-sm shrink-0">
                                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
                                    </div>
                                    <div>
                                        <div class="text-sm font-bold text-slate-300 group-hover:text-white leading-tight">Surat Kuasa RCP</div>
                                        <div class="text-[10px] text-slate-500 group-hover:text-brand-400 mt-0.5">Download .docx</div>
                                    </div>
                                </a>
                            </div>
    ...
    <section id="info" class="py-24 bg-dark-950">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 {{ ($isRpcEnabled || $isGoldenRun) ? 'md:grid-cols-2' : '' }} gap-12">
                ...
                <div class="reveal">
                    ...
                    <div class="bg-white/5 rounded-3xl p-8 border border-white/10">
                        ...
                        <a href="https://maps.google.com/?q={{ $event->rpc_latitude }},{{ $event->rpc_longitude }}" target="_blank" class="inline-flex items-center text-sm font-bold text-brand-400 hover:text-brand-300">
                            Buka Google Maps
                ...
                <div class="reveal {{ (!$isRpcEnabled && !$isGoldenRun) ? 'md:col-span-2' : 'delay-200' }}" id="venue">
                    ...
                    <div class="bg-dark-800 border border-white/10 shadow-lg rounded-3xl overflow-hidden h-full min-h-[300px] relative group">
                         @if($event->map_embed_url)
                            <iframe src="{{ $event->map_embed_url }}" class="w-full h-full min-h-[300px] border-0 grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 transition duration-500" allowfullscreen="" loading="lazy"></iframe>
                         @elseif($event->location_lat && $event->location_lng)
                            <iframe src="https://maps.google.com/maps?q={{ $event->location_lat }},{{ $event->location_lng }}&hl=id&z=14&output=embed" class="w-full h-full min-h-[300px] border-0 grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 transition duration-500" allowfullscreen="" loading="lazy"></iframe>
                         @else
                            <div class="absolute inset-0 bg-dark-800 flex items-center justify-center text-slate-500 font-bold">Map Loading...</div>
                         @endif
                         <div class="absolute bottom-4 left-4 right-4 bg-dark-900/90 backdrop-blur-sm p-4 rounded-xl border border-white/10 shadow-sm flex justify-between items-center gap-4">
                             <div class="min-w-0">
                             ...
                             <a href="https://www.google.com/maps/dir/?api=1&destination={{ $event->location_lat }},{{ $event->location_lng }}" target="_blank" class="shrink-0 bg-brand-500 text-black p-2.5 rounded-lg hover:bg-brand-400 transition shadow-lg shadow-brand-500/20" title="Get Directions">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                             </a>
                             @endif
                         </div>
            ...
            <!-- Race Rules Trigger -->
            <div class="mt-20 text-center reveal delay-300 hidden">
                <button onclick="document.getElementById('rulesModal').classList.remove('hidden')" class="inline-flex items-center gap-2 bg-white/10 text-white px-6 py-3 rounded-full hover:bg-white/20 transition font-bold border border-white/20 hover:border-brand-400 transform hover:-translate-y-0.5">
    ...
    <div id="rulesModal" class="fixed inset-0 z-50 hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="fixed inset-0 bg-black/80 backdrop-blur-sm transition-opacity" onclick="document.getElementById('rulesModal').classList.add('hidden')"></div>
        <div class="fixed inset-0 z-10 overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div class="relative transform overflow-hidden rounded-2xl bg-dark-900 text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-3xl border border-white/10">
                    <div class="bg-dark-950 px-4 py-6 sm:px-6 flex justify-between items-center border-b border-white/10">
                        <h3 class="text-xl font-bold leading-6 text-white flex items-center gap-2" id="modal-title">
                            <svg class="w-6 h-6 text-brand-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                            Peraturan Lomba
                        </h3>
                    ...
                    <div class="px-4 py-6 sm:p-8 max-h-[70vh] overflow-y-auto bg-dark-900">
                        <div class="space-y-8">
                            <!-- Waktu Penyelesaian -->
                            <div class="bg-white/5 p-6 rounded-2xl border border-white/10">
                                <h4 class="text-lg font-bold text-white mb-2 flex items-center gap-2">
                                    <span class="w-8 h-8 rounded-lg bg-blue-500/20 text-blue-400 flex items-center justify-center text-sm border border-blue-500/30">01</span>
                                    Waktu Penyelesaian (Cut-off Time)
                                </h4>
                                <p class="text-slate-400 pl-10">Peserta wajib menyelesaikan rute 5K dalam waktu maksimal <strong>1,5 jam</strong>. Peserta yang melewati batas waktu tidak berhak atas medali penamat.</p>
                            </div>

                            <!-- DNS -->
                            <div class="bg-white/5 p-6 rounded-2xl border border-white/10">
                                <h4 class="text-lg font-bold text-white mb-2 flex items-center gap-2">
                                    <span class="w-8 h-8 rounded-lg bg-red-500/20 text-red-400 flex items-center justify-center text-sm border border-red-500/30">02</span>
                                    DNS (Did Not Start)
                                </h4>
                                <p class="text-slate-400 pl-10">Peserta yang tidak memulai perlombaan (DNS) tidak berhak menerima medali penamat.</p>
                            </div>

                            <!-- BIB -->
                            <div class="bg-white/5 p-6 rounded-2xl border border-white/10">
                                <h4 class="text-lg font-bold text-white mb-2 flex items-center gap-2">
                                    <span class="w-8 h-8 rounded-lg bg-emerald-500/20 text-emerald-400 flex items-center justify-center text-sm border border-emerald-500/30">03</span>
                                    Nomor Peserta (BIB)
                                </h4>
                                <div class="text-slate-400 pl-10 space-y-2">
                            ...
                            <div class="bg-white/5 p-6 rounded-2xl border border-white/10">
                                <h4 class="text-lg font-bold text-white mb-2 flex items-center gap-2">
                                    <span class="w-8 h-8 rounded-lg bg-purple-500/20 text-purple-400 flex items-center justify-center text-sm border border-purple-500/30">04</span>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="bg-white/5 p-6 rounded-2xl border border-white/10">
                                    <h4 class="text-lg font-bold text-white mb-2 flex items-center gap-2">
                                        <span class="w-8 h-8 rounded-lg bg-cyan-500/20 text-cyan-400 flex items-center justify-center text-sm border border-cyan-500/30">05</span>
                                        Water Station
                                    </h4>
                                    <p class="text-slate-400 pl-10">Pos minum tersedia di titik-titik yang telah ditentukan sepanjang rute.</p>
                                </div>
                                <div class="bg-white/5 p-6 rounded-2xl border border-white/10">
                                    <h4 class="text-lg font-bold text-white mb-2 flex items-center gap-2">
                                        <span class="w-8 h-8 rounded-lg bg-orange-500/20 text-orange-400 flex items-center justify-center text-sm border border-orange-500/30">06</span>
                                        Larangan Kendaraan
                                    </h4>
                                    <p class="text-slate-400 pl-10">Penggunaan kendaraan bermotor maupun sepeda di jalur lomba sangat dilarang, kecuali untuk kepentingan penyelenggaraan.</p>
                                </div>
                            </div>
                            ...
                            <div class="bg-white/5 p-6 rounded-2xl border border-white/10">
                                <h4 class="text-lg font-bold text-white mb-2 flex items-center gap-2">
                                    <span class="w-8 h-8 rounded-lg bg-brand-500/20 text-brand-400 flex items-center justify-center text-sm border border-brand-500/30">07</span>
                                    Medali & Pemenang
                                </h4>
                                <div class="text-slate-400 pl-10 space-y-2">
                            ...
                            <div class="bg-white/5 p-6 rounded-2xl border border-white/10">
                                <h4 class="text-lg font-bold text-white mb-2 flex items-center gap-2">
                                    <span class="w-8 h-8 rounded-lg bg-pink-500/20 text-pink-400 flex items-center justify-center text-sm border border-pink-500/30">08</span>
                                    Keamanan & Kesehatan
                                </h4>
                                <div class="text-slate-400 pl-10 space-y-2">
                    ...
                    <div class="bg-dark-950 px-4 py-4 sm:px-6 sm:flex sm:flex-row-reverse border-t border-white/10">
                        <button type="button" class="mt-3 inline-flex w-full justify-center rounded-lg bg-white/10 px-3 py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-white/10 hover:bg-white/20 sm:mt-0 sm:w-auto transition" onclick="document.getElementById('rulesModal').classList.add('hidden')">Tutup</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="reveal delay-200">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-white/5 rounded-2xl border border-white/10 overflow-hidden">
                            <button class="w-full px-6 py-4 text-left font-bold text-white flex justify-between items-center hover:bg-white/5 transition" onclick="this.nextElementSibling.classList.toggle('hidden')">
                                {{ $faq['question'] }}
                            ...
                            <div class="px-6 pb-4 text-sm text-slate-400 hidden border-t border-white/5 pt-4">
                                {!! nl2br(e($faq['answer'])) !!}
                            </div>
                        </div>
                        @endforeach
    ...
    <section id="prizes" class="py-24 bg-dark-950 hidden">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12 reveal">
                ...
                <p class="mt-4 text-slate-400">Total hadiah puluhan juta rupiah menanti para juara.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 reveal delay-100">
                <!-- Category 1 --> 
                <div class="bg-white/5 rounded-3xl p-8 border border-white/10 shadow-sm hover:shadow-glow transition-all duration-500">
                    <h3 class="text-xl font-bold text-white mb-6 text-center border-b border-white/10 pb-4">
                        KATEGORI 5K UMUM <br>
                        <span class="text-brand-400 text-base font-medium">(PRIA & WANITA)</span>
                    </h3>
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="text-sm">
                                <tr class="border-b border-white/5">
                                    <td class="py-3 font-bold text-white">Juara 1</td>
                                    <td class="py-3 font-bold text-brand-400 text-right">Rp 2.000.000</td>
                                </tr>
                                <tr class="border-b border-white/5">
                                    <td class="py-3 font-bold text-white">Juara 2</td>
                                    <td class="py-3 font-bold text-brand-400 text-right">Rp 1.750.000</td>
                                </tr>
                                <tr class="border-b border-white/5">
                                    <td class="py-3 font-bold text-white">Juara 3</td>
                                    <td class="py-3 font-bold text-brand-400 text-right">Rp 1.500.000</td>
                                </tr>
                                <tr class="border-b border-white/5">
                                    <td class="py-3 font-medium text-slate-300">Peringkat 4</td>
                                    <td class="py-3 font-medium text-slate-300 text-right">Rp 1.250.000</td>
                                </tr>
                                <tr class="border-b border-white/5">
                                    <td class="py-3 font-medium text-slate-300">Peringkat 5</td>
                                    <td class="py-3 font-medium text-slate-300 text-right">Rp 1.000.000</td>
                                </tr>
                                <tr class="border-b border-white/5">
                                    <td class="py-3 font-medium text-slate-300">Peringkat 6</td>
                                    <td class="py-3 font-medium text-slate-300 text-right">Rp 500.000</td>
                                </tr>
                                <tr class="border-b border-white/5">
                                    <td class="py-3 font-medium text-slate-300">Peringkat 7</td>
                                    <td class="py-3 font-medium text-slate-300 text-right">Rp 500.000</td>
                                </tr>
                                <tr>
                                    <td class="py-3 font-medium text-slate-300">Peringkat 8</td>
                                    <td class="py-3 font-medium text-slate-300 text-right">Rp 500.000</td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody class="text-sm">
                                <tr class="border-b border-white/5">
                                    <td class="py-3 font-bold text-white">Juara 1</td>
                                    <td class="py-3 font-bold text-brand-400 text-right">Rp 1.250.000</td>
                                </tr>
                                <tr class="border-b border-white/5">
                                    <td class="py-3 font-bold text-white">Juara 2</td>
                                    <td class="py-3 font-bold text-brand-400 text-right">Rp 1.000.000</td>
                                </tr>
                                <tr class="border-b border-white/5">
                                    <td class="py-3 font-bold text-white">Juara 3</td>
                                    <td class="py-3 font-bold text-brand-400 text-right">Rp 750.000</td>
                                </tr>
                                <tr class="border-b border-white/5">
                                    <td class="py-3 font-medium text-slate-300">Peringkat 4</td>
                                    <td class="py-3 font-medium text-slate-300 text-right">Rp 500.000</td>
    ...
    <section id="register" class="py-24 bg-dark-900">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12 reveal">
              ...
              <button type="button" onclick="openLightbox('https://res.cloudinary.com/dslfarxct/image/upload/v1769987180/Panduan_trajpm.webp', true)" 
                    class="text-xs font-bold text-brand-400 hover:text-brand-300 mt-1.5 flex items-center gap-1 ml-1 transition-colors">
            ...
            @if(!$isRegOpen)
                <div class="bg-white/5 border border-white/10 rounded-3xl p-12 text-center max-w-2xl mx-auto">
                    <svg class="w-16 h-16 text-slate-500 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
            ...
            @else
                @if(request('payment') === 'pending')
                    <div class="w-full mb-8 bg-yellow-500/10 border border-yellow-500/30 text-yellow-200 p-6 rounded-3xl reveal">
                        <div class="flex flex-col md:flex-row md:items-start gap-5">
                            <div class="shrink-0 text-yellow-400 bg-yellow-500/20 p-3 rounded-2xl">
                            ...
                            <div class="flex-1">
                                <h3 class="font-bold text-xl mb-1 text-white">Menunggu Pembayaran</h3>
                                <p class="text-slate-300 leading-relaxed">Anda memiliki transaksi yang belum diselesaikan. Jika popup pembayaran sebelumnya tertutup atau hilang, Anda dapat melanjutkannya sekarang tanpa perlu mengisi data ulang.</p>
                                <div class="mt-4">
                                    <a href="{{ route('events.payments.continue', $event->slug) }}" class="inline-flex items-center gap-2 bg-yellow-500 hover:bg-yellow-400 text-black font-bold px-6 py-3 rounded-xl transition shadow-lg shadow-yellow-500/20 hover:shadow-yellow-500/40 hover:-translate-y-0.5">
                ...
                @elseif(request('payment') === 'success')
                    <div class="w-full mb-8 bg-green-500/10 border border-green-500/30 text-green-200 p-6 rounded-3xl reveal">
                        <div class="flex items-center gap-5">
                            <div class="shrink-0 text-green-400 bg-green-500/20 p-3 rounded-2xl">
                            ...
                            <div>
                                <h3 class="font-bold text-xl mb-1 text-white">Pembayaran Berhasil!</h3>
                                <p class="text-slate-300">Terima kasih telah mendaftar. Silakan cek email Anda (inbox/spam) untuk melihat E-Ticket dan detail acara.</p>
                            </div>
                        </div>
                    </div>
                @endif
                ...
                <form action="{{ route('events.register.store', ['slug' => $event->slug]) }}" method="POST" id="registrationForm" class="flex flex-col lg:flex-row gap-8 reveal-fade">
                    ...
                    <div class="flex-1 space-y-8">
                        ...
                        <div class="bg-white/5 border border-white/10 shadow-card rounded-3xl p-8">
                            <h3 class="text-lg font-bold text-white mb-6 flex items-center gap-2">
                                <span class="w-8 h-8 rounded-full bg-brand-500/20 text-brand-400 flex items-center justify-center text-sm border border-brand-500/30">1</span>
                                Data Penanggung Jawab
                            </h3>
                            <div class="space-y-4">
                                <div>
                                    <label class="block text-sm font-semibold text-slate-300 mb-1">Nama Lengkap</label>
                                    <input type="text" name="pic_name" class="w-full bg-dark-800 border border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent outline-none transition placeholder-slate-500" placeholder="Sesuai KTP" required>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-sm font-semibold text-slate-300 mb-1">Email</label>
                                        <input type="email" name="pic_email" class="w-full bg-dark-800 border border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent outline-none transition placeholder-slate-500" placeholder="email@contoh.com" required>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-semibold text-slate-300 mb-1">No. WhatsApp</label>
                                        <input type="text" name="pic_phone" class="w-full bg-dark-800 border border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent outline-none transition placeholder-slate-500" placeholder="0812xxxx" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white/5 border border-white/10 shadow-card rounded-3xl p-8">
                            <div class="flex justify-between items-center mb-6">
                                <h3 class="text-lg font-bold text-white flex items-center gap-2">
                                    <span class="w-8 h-8 rounded-full bg-brand-500/20 text-brand-400 flex items-center justify-center text-sm border border-brand-500/30">2</span>
                                    Data Peserta
                                </h3>
                                <button type="button" id="addParticipant" class="text-sm font-bold text-brand-400 border border-brand-400 px-4 py-2 rounded-full hover:bg-brand-500/10 transition">
                                    + Tambah Peserta
                                </button>
                            </div>

                            <div id="participantsWrapper" class="space-y-6">
                                <div class="participant-item bg-dark-800 border border-white/10 p-6 rounded-2xl relative" data-index="0">
                                    <div class="flex justify-between items-center mb-4 pb-2 border-b border-white/10">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <button type="button" class="copy-pic-btn text-[10px] bg-brand-500 text-black hover:bg-brand-400 hover:shadow-brand-500/30 hover:-translate-y-0.5 transition-all duration-300 px-2 py-0.5 rounded transition font-bold" onclick="copyFromPic(this)">
                                                Isi Dengan Data PIC
                                            </button>
                                            <button type="button" class="copy-prev-btn text-[10px] bg-brand-500 text-black hover:bg-brand-400 hover:shadow-brand-500/30 hover:-translate-y-0.5 transition-all duration-300 px-2 py-0.5 rounded transition hidden font-bold" onclick="copyFromPrev(this)">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                ...
                                                <label class="cursor-pointer relative">
                                                    ...
                                                    <div class="p-3 bg-dark-900 border border-white/10 rounded-xl peer-checked:border-brand-500 peer-checked:bg-brand-500/10 peer-checked:ring-1 peer-checked:ring-brand-500 transition hover:border-brand-400/50">
                                                        <div class="flex justify-between items-center">
                                                            <span class="font-bold text-white text-sm">{{ $cat->name }} Umum/Master</span>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <select name="participants[0][gender]" class="w-full bg-dark-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-brand-500 outline-none" required>
                                                ...
                                                <option value="female" class="bg-dark-900">Perempuan</option>
                                            </select>
                                        </div>
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <input type="email" name="participants[0][email]" placeholder="Email Peserta" class="w-full bg-dark-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-brand-500 outline-none placeholder-slate-500" required>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <input type="text" name="participants[0][emergency_contact_number]" placeholder="No. Kontak Darurat" class="w-full bg-dark-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-brand-500 outline-none placeholder-slate-500" required minlength="10" maxlength="15" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                        </div>
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div class="space-y-1 relative">
                                                <label class="text-xs font-bold text-slate-400 uppercase tracking-wider ml-1">Ukuran Jersey</label>
                                                
                                            <select name="participants[0][jersey_size]" class="w-full bg-dark-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-brand-500 outline-none" required>
                                                <option value="" class="bg-dark-900">Ukuran Jersey</option>
                                                @foreach(['XS','S','M','L','XL','XXL'] as $size) <option value="{{ $size }}" class="bg-dark-900">{{ $size }}</option> @endforeach
                                            </select>
                                            <button type="button" onclick="openLightbox('https://res.cloudinary.com/dslfarxct/image/upload/v1769987967/size_jersey_ktpwwy.webp', true)" class="text-xs font-bold text-brand-400 hover:text-brand-300 mt-1.5 flex items-center gap-1 ml-1 transition-colors">
                                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                                Panduan Ukuran
                                            </button>
                                            </div>
                                            <div class="space-y-1 relative hidden">
                                                <label class="text-xs font-bold text-slate-400 uppercase tracking-wider ml-1">Target Waktu (Jam:Mnt:Dtk)</label>
                                                <div class="flex gap-2">
                                                    <div class="relative flex-1">
                                                        <input type="number" min="0" max="23" placeholder="00" class="target-time-part target-time-h w-full bg-dark-900 border border-white/10 rounded-xl px-3 py-3 text-center text-white focus:ring-2 focus:ring-brand-500 outline-none font-mono font-bold placeholder-slate-600" oninput="if(this.value.length>2) this.value=this.value.slice(0,2)">
                                                        <span class="absolute right-2 top-3.5 text-[10px] text-slate-500 font-bold pointer-events-none">JAM</span>
                                                    </div>
                                                    <div class="relative flex-1">
                                                        <input type="number" min="0" max="59" placeholder="00" class="target-time-part target-time-m w-full bg-dark-900 border border-white/10 rounded-xl px-3 py-3 text-center text-white focus:ring-2 focus:ring-brand-500 outline-none font-mono font-bold placeholder-slate-600" oninput="if(this.value.length>2) this.value=this.value.slice(0,2)">
                                                        <span class="absolute right-2 top-3.5 text-[10px] text-slate-500 font-bold pointer-events-none">MNT</span>
                                                    </div>
                                                    <div class="relative flex-1">
                                                        <input type="number" min="0" max="59" placeholder="00" class="target-time-part target-time-s w-full bg-dark-900 border border-white/10 rounded-xl px-3 py-3 text-center text-white focus:ring-2 focus:ring-brand-500 outline-none font-mono font-bold placeholder-slate-600" oninput="if(this.value.length>2) this.value=this.value.slice(0,2)">
                                                        <span class="absolute right-2 top-3.5 text-[10px] text-slate-500 font-bold pointer-events-none">DTK</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="grid grid-cols-1 gap-4 mt-2">
                                            <div class="space-y-1">
                                                <label class="text-xs font-bold text-slate-300 uppercase tracking-wider ml-1">Link Aktivitas Strava <span class="text-red-500">*</span></label>
                                                <input type="url" name="participants[0][strava_url]" placeholder="https://www.strava.com/activities/..." class="w-full bg-dark-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-brand-500 outline-none" required>
                                        ...
                                        <div class="mt-4 border-t border-white/10 pt-4">
                                            ...
                                            <div class="grid grid-cols-1 gap-3">
                                                @foreach($event->addons as $idx => $addon)
                                                    <label class="flex items-center justify-between p-3 bg-dark-900 border border-white/10 rounded-xl hover:border-brand-400 transition cursor-pointer group">
                                                        <div class="flex items-center gap-3">
                                                             <div class="relative flex items-center">
                                                                <input type="checkbox" 
                                                                    name="participants[0][addons][{{ $idx }}][selected]" 
                                                                    value="1" 
                                                                    class="addon-checkbox w-5 h-5 rounded text-brand-500 focus:ring-brand-500 border-slate-600 bg-dark-800 group-hover:bg-dark-700 transition"
                                                             ...
                                                             <div>
                                                                <span class="block text-sm font-bold text-white group-hover:text-brand-400 transition">{{ $addon['name'] }}</span>
                                                             </div>
                                                        </div>
                    ...
                    <div class="lg:w-96 flex-shrink-0 lg:sticky lg:top-28 lg:self-start">
                        <div class="space-y-6">
                            ...
                            <div class="bg-white/5 border border-white/10 rounded-2xl p-6 shadow-sm">
                                ...
                                <div class="flex gap-2">
                                    <input type="text" id="coupon_code" placeholder="KODE..." class="flex-1 bg-dark-800 border border-white/10 rounded-lg px-3 py-2 text-sm uppercase font-bold outline-none text-white focus:border-brand-500 placeholder-slate-600">
                                    <button type="button" id="applyCoupon" class="bg-white/10 text-white px-4 rounded-lg text-sm font-bold hover:bg-white/20 transition border border-white/10">Pakai</button>
                                </div>
                                ...
                                <button type="button" onclick="openPromoModal()" class="mt-3 text-[11px] font-semibold text-brand-400 hover:text-brand-300 underline underline-offset-2">
                            ...
                            <div id="paymentSummarySection" class="bg-dark-900 border border-brand-500/30 rounded-3xl p-8 shadow-2xl shadow-brand-500/10 relative overflow-hidden">
                                ...
                                <div class="space-y-3 mb-6 border-b border-white/10 pb-6 relative z-10 text-sm">
                                ...
                                <div class="mb-6 relative z-10 space-y-3">
                                    ...
                                    @if($showMidtrans)
                                    <label class="flex items-center gap-3 p-3 bg-white/5 border border-white/10 rounded-xl cursor-pointer hover:bg-white/10 transition group">
                                        <input type="radio" name="payment_method" value="midtrans" class="w-4 h-4 text-brand-500 focus:ring-brand-500 bg-dark-800 border-slate-600" {{ $showMidtrans && !$showMoota ? 'checked' : '' }} required>
                                        <div class="flex-1">
                                            <span class="block text-sm font-bold text-white group-hover:text-brand-400 transition">Otomatis (Midtrans)</span>
                                    ...
                                    @if($showMoota)
                                    <label class="flex items-center gap-3 p-3 bg-white/5 border border-white/10 rounded-xl cursor-pointer hover:bg-white/10 transition group">
                                        <input type="radio" name="payment_method" value="moota" class="w-4 h-4 text-brand-500 focus:ring-brand-500 bg-dark-800 border-slate-600" {{ !$showMidtrans && $showMoota ? 'checked' : '' }} required>
                                        <div class="flex-1">
                                            <span class="block text-sm font-bold text-white group-hover:text-brand-400 transition">Transfer Bank (Moota)</span>
                                ...
                                <div class="flex justify-between items-end mb-8 relative z-10">
                                    ...
                                    <span id="totalDisplay" class="text-3xl font-bold text-brand-400 tracking-tight">Rp 0</span>
                                </div>

                                @if($event->terms_and_conditions)
                                <div class="mb-6 relative z-10">
                                    <label class="flex items-start gap-3 cursor-pointer">
                                        <input type="checkbox" name="terms_agreed" required class="mt-1 w-4 h-4 rounded text-brand-500 focus:ring-brand-500 border-slate-600 bg-dark-800">
                                        <span class="text-xs text-slate-400">
                                            Saya setuju dengan <button type="button" onclick="document.getElementById('termsModal').classList.remove('hidden')" class="text-brand-400 underline font-bold animate-pulse hover:text-brand-300 transition-colors">Peraturan, Syarat & Ketentuan</button>.
                                        </span>
                                    </label>
                                </div>
                                @endif

                                <button type="submit" id="submitBtn" class="w-full py-4 bg-gradient-to-r from-brand-400 to-brand-600 text-black font-bold rounded-xl hover:shadow-lg hover:shadow-brand-500/20 transition-all duration-300 relative z-10 hover:-translate-y-0.5">
                                    Lanjut Pembayaran
                                </button>
                                ...
                                <div class="mt-4 text-center relative z-10">
                                    <button type="button" onclick="window.resetRegistrationForm()" class="text-xs text-slate-500 hover:text-brand-400 underline transition-colors flex items-center justify-center gap-1 mx-auto">
    ...
    <section id="ugc" class="py-20 bg-dark-950 border-t border-white/5">
    <div class="max-w-6xl mx-auto px-4">
        <div class="flex flex-col items-center text-center mb-12 space-y-4">
            <span class="text-[11px] font-semibold tracking-[0.35em] uppercase text-brand-950 bg-brand-400 px-4 py-1 rounded-full shadow-lg shadow-brand-500/20">
                Share The Hype
            </span>
            <h2 class="text-3xl md:text-4xl font-black text-white tracking-tight">
                Ubah Pendaftaranmu Jadi <span class="text-brand-400 drop-shadow-[0_0_15px_rgba(251,191,36,0.5)]">Cerita</span>
            </h2>
            <p class="text-slate-400 max-w-2xl text-sm md:text-base">
                Setelah daftar, jangan diam saja. Buat kartu <span class="font-semibold text-white">&quot;I&apos;m Ready&quot;</span>, post di story,
        ...
        <div class="flex flex-col lg:flex-row gap-10 items-center justify-center">
            <div class="w-full max-w-[420px]">
                <div class="bg-dark-900 p-3 rounded-2xl shadow-2xl border border-white/10">
            ...
            <div class="w-full max-w-md space-y-6">
                <div id="ugcDropzone" class="border-2 border-dashed border-white/10 bg-white/5 p-8 rounded-3xl text-center cursor-pointer hover:border-brand-500/50 hover:bg-white/10 transition-all group">
                    <input id="ugcFileInput" type="file" accept="image/*" class="hidden">
                    <div class="space-y-4">
                        <div class="w-12 h-12 bg-brand-500/10 text-brand-400 mx-auto rounded-full flex items-center justify-center group-hover:bg-brand-500/20 transition">
                ...
                <button id="ugcDownloadBtn" disabled class="w-full py-4 bg-gradient-to-r from-brand-400 to-brand-600 hover:from-brand-300 hover:to-brand-500 disabled:opacity-25 disabled:cursor-not-allowed text-black font-bold uppercase rounded-2xl transition-all shadow-lg shadow-brand-500/20 text-sm tracking-wide">
                    Unduh &amp; Bagikan Kartu &quot;I&apos;m Ready&quot;
                </button>

                <p class="text-[11px] text-slate-500 leading-relaxed">
                    Setelah diunduh, post di Instagram Story atau WhatsApp Status dengan caption
                    <span class="text-brand-400 font-semibold">&quot;I&apos;m registered, are you?&quot;</span> dan mention teman yang ingin kamu ajak.
                </p>
            </div>
        </div>
    </div>
    ...
    @include('events.partials.sponsor-carousel', [
        'gradientFrom' => 'from-dark-950',
        'titleColor' => 'text-slate-500',
        'containerClass' => 'bg-white/5 grayscale hover:grayscale-0 transition-all duration-500 border border-white/5',
        'sectionClass' => 'py-16 bg-dark-950 border-t border-white/5'
    ])

    <footer class="bg-dark-950 border-t border-white/5 py-12 text-slate-500 text-sm">
...
(function() {
    ...
    <a href="https://wa.link/hcne61" target="_blank" rel="noopener noreferrer" class="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-3 rounded-full shadow-lg hover:bg-[#20bd5a] hover:scale-110 transition-all duration-300 flex items-center justify-center group">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateIcons(isLight) {
                ...
                const text = isLight ? 'Mode Gelap' : 'Mode Terang';
                ...
                if(themeToggleMobile) {
                    ...
                    const span = document.getElementById('themeTextMobile');
                    if(icon) icon.className = `fas ${iconClass} w-5 text-center`;
