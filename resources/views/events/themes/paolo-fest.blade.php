        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @else
                ...
                <div id="ktpScanModal" class="fixed inset-0 z-[300] hidden items-center justify-center">
                    ...
                    <div class="relative w-full max-w-5xl bg-white border border-slate-200 rounded-3xl shadow-2xl max-h-[90vh] overflow-hidden flex flex-col">
                        ...
                        <div class="px-6 md:px-8 pb-6 md:pb-8 overflow-y-auto min-h-0">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                        ...
                        <div class="px-6 md:px-8 pb-6 md:pb-8 pt-4 border-t border-slate-200 bg-white">
