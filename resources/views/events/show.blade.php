                                        ...
                                        <div class="participant-item bg-slate-900/50 border border-slate-700 hover:border-slate-500 p-6 rounded-2xl transition relative group" data-index="0">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div class="space-y-1">
                                                    ...
                                                    <input type="time" name="participants[0][target_time]" class="w-full bg-input border border-slate-700 rounded-lg px-3 py-2 text-sm text-white focus:border-neon outline-none">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                      ...
                      <div class="space-y-4 text-sm text-slate-300">
                          ...
                          <div class="flex gap-3">
                              ...
                              <div>
                                  ...
                                  <p>{{ $event->location_name }} (Lobby Area)</p>
                              </div>
                          </div>
                      ...
                      <div class="space-y-4 text-sm text-slate-300">
                          ...
                          <div class="flex gap-3">
                              ...
                              <div>
                                  ...
                                  <p>Parkir tersedia terbatas di area Basement P1 & P2.</p>
