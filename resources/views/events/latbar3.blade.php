                            ...
                            <div class="animate-fade-in delay-300">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div class="payment-card" v-if="prices.base > 0" :class="{'active': form.payment_method === 'moota'}" @click="form.payment_method = 'moota'">
                                        ...
                                        <div class="text-[10px] text-gray-500 mt-1">BCA</div>
                                    </div>
        ...
        <section class="mt-10 px-4 md:px-0">
            <div class="max-w-6xl mx-auto glass-dark border border-white/10 rounded-2xl p-6 md:p-8">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button type="button" id="openFeaturedModal" onclick="document.getElementById('featuredModal').classList.remove('hidden')" class="px-3 py-1.5 rounded-lg bg-sport-volt text-black font-bold text-xs">Lihat Semua</button>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    @foreach($featuredEvents->take(4) as $fe)
                        @php
