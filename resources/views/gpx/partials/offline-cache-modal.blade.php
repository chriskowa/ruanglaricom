...
<div id="modal-gpx-offline-cache" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm hidden" style="z-index: 99999;">
    <div class="relative w-full max-w-lg bg-[#0c121e] border border-slate-700/80 rounded-2xl p-6 shadow-2xl overflow-hidden text-slate-200 font-sans">
        ...
        <div class="flex items-start justify-between gap-3 pb-4 border-b border-slate-800">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400">Gunakan navigasi GPS di gunung atau blind-spot tanpa kuota internet.</p>
                </div>
            </div>
            <button type="button" onclick="closeOfflineCacheModal()" class="text-slate-400 hover:text-white p-1 rounded-lg hover:bg-slate-800 transition cursor-pointer" title="Tutup Modal">
        ...
        <div class="mt-4 space-y-4">
            ...
            <div id="offline-status-banner" class="p-3.5 rounded-xl border flex items-start gap-3 text-xs bg-slate-900/80 border-slate-800">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div id="offline-status-desc" class="text-slate-400 mt-0.5 leading-relaxed">
            ...
            <div class="grid grid-cols-2 gap-2 text-xs">
                <div class="p-2.5 rounded-xl bg-slate-900/60 border border-slate-800 flex items-center gap-2">
                    <i class="fa-solid fa-check text-emerald-400 text-xs"></i>
                    <span class="text-slate-300">Peta Layer Offline (Zoom 13-16)</span>
                </div>
                <div class="p-2.5 rounded-xl bg-slate-900/60 border border-slate-800 flex items-center gap-2">
                    <i class="fa-solid fa-check text-emerald-400 text-xs"></i>
                    <span class="text-slate-300">Live GPS & Off-Course Voice</span>
                </div>
                <div class="p-2.5 rounded-xl bg-slate-900/60 border border-slate-800 flex items-center gap-2">
                    <i class="fa-solid fa-check text-emerald-400 text-xs"></i>
                    <span class="text-slate-300">Elevasi Profil & Target Pace</span>
                </div>
                <div class="p-2.5 rounded-xl bg-slate-900/60 border border-slate-800 flex items-center gap-2">
                    <i class="fa-solid fa-check text-emerald-400 text-xs"></i>
                    <span class="text-slate-300">Ukuran Hemat (~1 - 3 MB)</span>
                </div>
            </div>

            <!-- Download Progress Bar (Hidden by default) -->
            <div id="offline-progress-wrap" class="hidden space-y-2 p-3.5 rounded-xl bg-slate-950 border border-slate-800">
            ...
            <div class="p-3 rounded-xl bg-slate-900/60 border border-slate-800/80 text-[11px] text-slate-400 flex items-start gap-2.5">
                <i class="fa-solid fa-compass text-[#FC4C02] text-xs mt-0.5 shrink-0"></i>
                <p class="leading-relaxed">
                    <strong class="text-slate-200">Tips di Gunung:</strong> Nyalakan mode <em>Airplane Mode</em> untuk menghemat baterai HP hingga 3x lipat saat menggunakan navigasi GPS ini di jalur pendakian.
                </p>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between gap-3 pt-4 mt-5 border-t border-slate-800">
            ...
            <div class="flex items-center gap-2 ml-auto">
                ...
                <button type="button" 
                        ...
                        class="px-4 py-2 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black text-xs transition flex items-center gap-1.5 cursor-pointer shadow-lg shadow-emerald-500/20">
