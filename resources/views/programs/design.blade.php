    ...
    <main class="relative z-10 flex-grow flex flex-col justify-center items-center w-full">
        ...
        <transition name="fade" mode="out-in">
            ...
            <div v-if="step === 0" key="hero" class="text-center max-w-4xl py-10">
                ...
                Ruang Lari berkomitmen untuk membuat atmosfer komunitas lari yang sehat, kebersamaan dan keberlanjutan Dengan  konsistensi dan supportifitas. Kami menghitung <span class="text-cyan-400 font-bold">Gap</span>, menganalisis <span class="text-cyan-400 font-bold">Realita</span>, dan membangun <span class="text-purple-400 font-bold">Tangga Progresi</span> (Ladder) khusus untuk fisiologis Anda.
                </p>
