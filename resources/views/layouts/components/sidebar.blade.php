<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            @auth
                ...
                @elseif(auth()->user()->isCoach())
                    ...
                    <li><a class="ai-icon" href="{{ route('coach.programs.index') }}" aria-expanded="false">
            ...
            @else
                ...
                <li><a class="ai-icon" href="{{ route('register') }}" aria-expanded="false">
        ...
        <div class="copyright">
            <p><strong>Ruang Lari</strong> © 2025 All Rights Reserved</p>
        </div>
    </div>
</div>
