        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
            ...
            <div class="lg:col-span-2 space-y-4">
                ...
                <div class="flex gap-3 pt-3">
                    @if($socialInsta)
                    <a href="{{ $socialInsta }}" target="_blank" rel="noopener noreferrer" aria-label="Instagram RuangLari" class="w-9 h-9 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:bg-neon hover:text-slate-950 transition"><i class="fab fa-instagram"></i></a>
                    @endif
                    @if($socialTiktok)
                    <a href="{{ $socialTiktok }}" target="_blank" rel="noopener noreferrer" aria-label="TikTok RuangLari" class="w-9 h-9 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:bg-neon hover:text-slate-950 transition"><i class="fab fa-tiktok"></i></a>
                    @endif
                    @if($socialFb)
                    <a href="{{ $socialFb }}" target="_blank" rel="noopener noreferrer" aria-label="Facebook RuangLari" class="w-9 h-9 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:bg-neon hover:text-slate-950 transition"><i class="fab fa-facebook-f"></i></a>
                    @endif
                    @if($socialYt)
                    <a href="{{ $socialYt }}" target="_blank" rel="noopener noreferrer" aria-label="YouTube RuangLari" class="w-9 h-9 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:bg-neon hover:text-slate-950 transition"><i class="fab fa-youtube"></i></a>
                    @endif
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm font-medium">
                    <li><a href="{{ route('programs.index') }}" class="hover:text-white hover:translate-x-1 inline-block transition">Katalog Program VDOT</a></li>
                    <li><a href="{{ route('landing.program-lari-5k-pemula') }}" class="hover:text-white hover:translate-x-1 inline-block transition">Program Lari 5K Pemula</a></li>
                    <li><a href="{{ route('landing.program-lari-10k') }}" class="hover:text-white hover:translate-x-1 inline-block transition">Program Lari 10K Speed</a></li>
                    <li><a href="{{ route('landing.program-half-marathon') }}" class="hover:text-white hover:translate-x-1 inline-block transition">Program Half Marathon</a></li>
                    <li><a href="{{ route('run-connect.index') }}" class="hover:text-white hover:translate-x-1 inline-block transition">Cari Teman Lari (Connect)</a></li>
                    <li><a href="{{ route('coaches.index') }}" class="hover:text-white hover:translate-x-1 inline-block transition">Pelatih & Coach Lari</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm font-medium">
                    <li><a href="{{ route('events.index') }}" class="hover:text-white hover:translate-x-1 inline-block transition">Jadwal Event Lari 2026</a></li>
                    <li><a href="{{ route('community.register.index') }}" class="hover:text-white hover:translate-x-1 inline-block transition">Direktori Komunitas Lari</a></li>
                    ...
                    <li><a href="{{ route('challenge.index') }}" class="hover:text-white hover:translate-x-1 inline-block transition">Leaderboard Pelari</a></li>
            ...
            <div>
                ...
                <div class="pt-4 border-t border-slate-900 mt-4 flex items-center justify-between text-xs text-slate-400">
                    <a href="{{ url('/blog') }}" class="hover:text-white transition font-medium">Blog & Artikel Lari</a>
                    <span>•</span>
                    <a href="{{ route('about') }}" class="hover:text-white transition font-medium">Tentang RuangLari</a>
                </div>
            </div>
