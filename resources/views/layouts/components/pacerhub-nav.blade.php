                ...
                <div class="relative" id="user-menu-container">
                    ...
                    <div id="user-menu-dropdown" class="absolute right-0 mt-4 w-56 bg-slate-900/95 backdrop-blur-xl border border-slate-700 rounded-2xl shadow-2xl hidden transform transition-all origin-top-right z-50">
                        ...
                        <div class="p-2 space-y-1">
                            <a href="{{ route('profile.show') }}" class="flex items-center gap-1 px-1 py-2 text-sm text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors">
                            ...
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="w-full flex items-center gap-1 px-1 py-2 text-sm text-red-400 hover:bg-red-500/10 hover:text-red-300 rounded-lg transition-colors">
