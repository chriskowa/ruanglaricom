            ...
            <div class="flex items-center gap-1">
                ...
                <div class="relative" id="notification-container">
                    <button id="nav-bell-btn" class="p-1 rounded-lg hover:bg-slate-800 text-slate-300 transition-colors relative" title="Notifications">
                        ...
                        <span id="notification-badge" class="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 bg-red-500 text-[10px] font-bold text-white rounded-full flex items-center justify-center border border-slate-900 hidden"></span>
                    </button>
                ...
                <div class="flex items-center gap-3 xs:gap-2">
                    <button onclick="openLoginModal()" class="text-sm font-bold text-slate-300 hover:text-white transition-colors">Login</button>
                    <button onclick="openRegisterModal()" class="px-4 py-2 text-sm font-bold bg-neon text-dark rounded-xl hover:bg-lime-400 hover:shadow-lg hover:shadow-neon/20 transition-all transform hover:-translate-y-0.5">Register</button>
                </div>
                @endguest
