        ...
        <div class="glass p-8 rounded-3xl shadow-2xl">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <a href="{{ route('auth.google') }}" class="py-3 px-4 rounded-xl border border-slate-600 hover:border-white text-white font-bold text-sm transition-all flex items-center justify-center gap-2 hover:bg-slate-800">
                    ...
                    <a href="{{ route('auth.strava') }}" class="py-3 px-4 rounded-xl border border-orange-500/50 hover:border-orange-400 bg-orange-500/10 hover:bg-orange-500/20 text-orange-400 hover:text-white font-bold text-sm transition-all flex items-center justify-center gap-2">
                        <svg class="w-5 h-5 fill-current text-[#FC4C02]" viewBox="0 0 24 24">
