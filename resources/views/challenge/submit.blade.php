...
@section('content')
    <div id="submit-app" class="relative w-full min-h-screen pb-24 pt-20 px-4" v-cloak>
        ...
        <div v-if="builderVisible" class="fixed inset-0 z-[80] overflow-y-auto">
            <div class="fixed inset-0 bg-black/80 z-[70]" @click="closeBuilder"></div>
            <div class="relative z-[80] max-w-2xl mx-auto my-10 glass-panel rounded-2xl p-6">
