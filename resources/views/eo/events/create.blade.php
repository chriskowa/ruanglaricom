                        ...
                        <div class="bg-slate-900 border border-slate-700 rounded-xl p-4 flex flex-col sm:flex-row sm:items-center gap-4">
                            <div class="flex items-center gap-3">
                                <div class="relative w-12 h-12 rounded-xl overflow-hidden border-2 border-slate-600 shadow-sm shrink-0 cursor-pointer">
                                    <input type="color" id="primaryColorPicker" value="{{ old('theme_colors.primary', '#f1631e') }}" class="absolute -top-4 -left-4 w-20 h-20 cursor-pointer border-0 p-0" oninput="updatePrimaryColor(this.value)">
                                </div>
                                <div>
                                    <label class="text-[11px] font-bold uppercase tracking-wider text-slate-400">Hex Code</label>
                                    <div class="flex items-center gap-2 mt-1">
                                        <input type="text" id="primaryColorHex" name="theme_colors[primary]" value="{{ old('theme_colors.primary', '#f1631e') }}" placeholder="#f1631e" maxlength="7" class="w-28 bg-slate-800 border border-slate-700 rounded-lg px-3 py-1.5 text-sm font-mono font-bold text-white focus:border-yellow-400 focus:outline-none uppercase" oninput="updatePrimaryColorFromText(this.value)">
                                    </div>
                                </div>
                            </div>
