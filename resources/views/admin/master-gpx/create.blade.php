        ...
        <div class="max-w-4xl mx-auto">
            ...
            <form method="POST" action="{{ route('admin.master-gpx.store') }}" enctype="multipart/form-data" class="bg-card/50 backdrop-blur-md border border-slate-700/50 rounded-2xl p-6 space-y-4">
                ...
                <div>
                    ...
                    <input name="city" value="{{ old('city') }}" class="mt-1 w-full bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-3 text-white font-semibold focus:outline-none focus:ring-2 focus:ring-neon/30 focus:border-neon/50" placeholder="Mis. Jakarta Pusat">
                </div>
