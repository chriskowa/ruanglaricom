                    ...
                    <tr class="hover:bg-slate-700/20 transition-colors group">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <img src="{{ $article->featured_image_url }}" alt="" class="w-12 h-12 object-cover rounded-md" onerror="this.onerror=null;this.src='{{ asset('ruanglari.webp') }}';">
                                @else
                                <div class="w-12 h-12 bg-slate-800 rounded-md flex items-center justify-center text-slate-600">
