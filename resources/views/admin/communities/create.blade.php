...
<div class="min-h-screen pt-20 pb-10 px-4 md:px-8 relative overflow-hidden font-sans">
    <div class="max-w-4xl mx-auto">
        <div class="mb-8 flex items-center justify-between">
            <h1 class="text-3xl font-black text-white italic tracking-tighter">CREATE COMMUNITY</h1>
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" class="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white focus:outline-none focus:border-neon" required>
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-slate-400 mb-2">Slug</label>
                                <input type="text" name="slug" value="{{ old('slug') }}" class="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white focus:outline-none focus:border-neon" required>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="theme_color" class="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white focus:outline-none focus:border-neon">
                                    <option value="neon" {{ old('theme_color') == 'neon' ? 'selected' : '' }}>Neon (Default)</option>
                                    <option value="dark" {{ old('theme_color') == 'dark' ? 'selected' : '' }}>Dark</option>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" rows="3" class="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white focus:outline-none focus:border-neon">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="url" name="wa_group_link" value="{{ old('wa_group_link') }}" class="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white focus:outline-none focus:border-neon" placeholder="https://chat.whatsapp.com/...">
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-slate-400 mb-2">Instagram Link</label>
                                <input type="url" name="instagram_link" value="{{ old('instagram_link') }}" class="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white focus:outline-none focus:border-neon" placeholder="https://instagram.com/...">
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-slate-400 mb-2">TikTok Link</label>
                                <input type="url" name="tiktok_link" value="{{ old('tiktok_link') }}" class="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white focus:outline-none focus:border-neon" placeholder="https://tiktok.com/@...">
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="text" name="pic_name" value="{{ old('pic_name') }}" class="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white focus:outline-none focus:border-neon" required>
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-slate-400 mb-2">PIC Email</label>
                                <input type="email" name="pic_email" value="{{ old('pic_email') }}" class="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white focus:outline-none focus:border-neon" required>
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-slate-400 mb-2">PIC Phone</label>
                                <input type="text" name="pic_phone" value="{{ old('pic_phone') }}" class="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white focus:outline-none focus:border-neon" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="captains-container" class="space-y-4">
                            @if(old('captains'))
                                @foreach(old('captains') as $index => $captain)
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let captainIndex = {{ count(old('captains', [])) }};
