        ...
        <div class="content">
            ...
            <div class="ticket">
                ...
                <table width="100%" cellpadding="6" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td class="ticket-label">No. Identitas</td>
                    ...
                    <tr>
                        <td class="ticket-label">Tgl Lahir</td>
                        <td class="ticket-value">
                    ...
                    <tr>
                        <td class="ticket-label">Gol. Darah</td>
                    ...
                    <tr>
                        ...
                        <td class="ticket-value">
                            <a href="{{ $participant->strava_url }}" target="_blank" style="color: #2563eb; text-decoration: underline;">{{ $participant->strava_url }}</a>
                        </td>
                    </tr>
                    @endif
