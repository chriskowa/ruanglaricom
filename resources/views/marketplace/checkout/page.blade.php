...
<div class="min-h-screen pt-24 pb-20 px-4 md:px-8 font-sans bg-dark text-slate-200">
    <div class="max-w-5xl mx-auto">
        ...
        @if(session('error'))
            <div class="bg-red-500/10 border border-red-500/50 rounded-xl p-4 flex items-start gap-3 mb-4">
        ...
        @if($errors->any())
            <div class="bg-red-500/10 border border-red-500/50 rounded-xl p-4 mb-4">
        ...
        <form action="{{ route('marketplace.checkout.process', $order->id) }}" method="POST" id="marketplace-checkout-form">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-slate-900/80 backdrop-blur-md rounded-2xl border border-slate-800 p-6 md:p-8 shadow-xl">
                    ...
                    <div class="bg-slate-900/80 backdrop-blur-md rounded-2xl border border-slate-800 p-6 md:p-8 shadow-xl">
                        ...
                        <button
                            ...
                            class="mt-6 w-full py-4 bg-neon hover:bg-white hover:text-dark text-dark font-black text-lg rounded-xl transition-all shadow-lg shadow-neon/20 flex items-center justify-center gap-2 group disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                    ...
                    <div class="sticky top-24">
                        <div class="bg-slate-900/80 backdrop-blur-md rounded-2xl border border-slate-800 p-6 shadow-xl">
                            <h3 class="text-lg font-bold text-white mb-6 flex items-center gap-2">
                                <svg class="w-5 h-5 text-neon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 012-2h2a2 2 0 012 2" /></svg>
                                Ringkasan Order
                            </h3>
