...
<div id="mp-share-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm hidden" onclick="if(event.target===this) closeShareModal();">
    <div class="bg-slate-900 border border-slate-800 rounded-3xl p-6 max-w-sm w-full mx-4 shadow-2xl relative">
        ...
        <div class="flex items-center gap-3 mb-4">
            <div class="w-10 h-10 rounded-md bg-neon/10 border border-neon/30 flex items-center justify-center text-neon shrink-0">
        ...
        <div class="grid grid-cols-4 gap-2.5 my-5">
            <!-- WhatsApp -->
            <a id="mp-share-wa" href="#" target="_blank" class="flex flex-col items-center gap-1.5 p-3 rounded-md bg-slate-800 border border-slate-700 text-white hover:bg-slate-700 transition group">
                <i class="fa-brands fa-whatsapp text-2xl group-hover:scale-105 transition-transform"></i>
                <span class="text-[10px] font-bold">WhatsApp</span>
            </a>
            <!-- Facebook -->
            <a id="mp-share-fb" href="#" target="_blank" class="flex flex-col items-center gap-1.5 p-3 rounded-md bg-slate-800 border border-slate-700 text-white hover:bg-slate-700 transition group">
                <i class="fa-brands fa-facebook text-2xl group-hover:scale-105 transition-transform"></i>
                <span class="text-[10px] font-bold">Facebook</span>
            </a>
            <!-- X / Twitter -->
            <a id="mp-share-tw" href="#" target="_blank" class="flex flex-col items-center gap-1.5 p-3 rounded-md bg-slate-800 border border-slate-700 text-slate-200 hover:bg-slate-700 transition group">
                <i class="fa-brands fa-x-twitter text-2xl group-hover:scale-105 transition-transform"></i>
                <span class="text-[10px] font-bold">Twitter</span>
            </a>
            <!-- Copy Link -->
            <button type="button" onclick="copyShareLink()" class="flex flex-col items-center gap-1.5 p-3 rounded-md bg-slate-800 border border-slate-700 text-neon hover:bg-slate-700 transition group">
                <i class="fa-solid fa-link text-2xl group-hover:scale-105 transition-transform"></i>
                <span class="text-[10px] font-bold">Salin Link</span>
            </button>
        </div>

        <div class="relative mt-2">
            <input id="mp-share-url-input" type="text" readonly class="w-full bg-slate-950 border border-slate-800 rounded-md px-3 py-2 pr-16 text-xs text-slate-300 focus:outline-none select-all font-medium font-mono">
            <button type="button" onclick="copyShareLink()" class="absolute right-1.5 top-1/2 -translate-y-1/2 px-3 py-1 rounded bg-neon text-dark text-[10px] font-black hover:bg-white transition-colors">
