...
<div id="mp-share-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm hidden" onclick="if(event.target===this) closeShareModal();">
    <div class="bg-slate-900 border border-slate-800 rounded-3xl p-6 max-w-sm w-full mx-4 shadow-2xl relative">
        ...
        <div class="flex items-center gap-3 mb-4">
            <div class="w-10 h-10 rounded-2xl bg-white/10 border border-white/20 flex items-center justify-center text-white shrink-0">
        ...
        <div class="grid grid-cols-4 gap-2.5 my-5">
            <!-- WhatsApp -->
            <a id="mp-share-wa" href="#" target="_blank" class="flex flex-col items-center gap-1.5 p-3 rounded-2xl bg-slate-950/60 border border-slate-800 text-white hover:bg-slate-800 hover:border-slate-700 transition group">
                <i class="fa-brands fa-whatsapp text-2xl text-white group-hover:scale-110 transition-transform"></i>
                <span class="text-[10px] font-bold text-slate-300 group-hover:text-white">WhatsApp</span>
            </a>
            <!-- Facebook -->
            <a id="mp-share-fb" href="#" target="_blank" class="flex flex-col items-center gap-1.5 p-3 rounded-2xl bg-slate-950/60 border border-slate-800 text-white hover:bg-slate-800 hover:border-slate-700 transition group">
                <i class="fa-brands fa-facebook text-2xl text-white group-hover:scale-110 transition-transform"></i>
                <span class="text-[10px] font-bold text-slate-300 group-hover:text-white">Facebook</span>
            </a>
            <!-- X / Twitter -->
            <a id="mp-share-tw" href="#" target="_blank" class="flex flex-col items-center gap-1.5 p-3 rounded-2xl bg-slate-950/60 border border-slate-800 text-white hover:bg-slate-800 hover:border-slate-700 transition group">
                <i class="fa-brands fa-x-twitter text-2xl text-white group-hover:scale-110 transition-transform"></i>
                <span class="text-[10px] font-bold text-slate-300 group-hover:text-white">Twitter</span>
            </a>
            <!-- Copy Link -->
            <button type="button" onclick="copyShareLink()" class="flex flex-col items-center gap-1.5 p-3 rounded-2xl bg-slate-950/60 border border-slate-800 text-white hover:bg-slate-800 hover:border-slate-700 transition group">
                <i class="fa-solid fa-link text-2xl text-white group-hover:scale-110 transition-transform"></i>
                <span class="text-[10px] font-bold text-slate-300 group-hover:text-white">Salin</span>
            </button>
        </div>
