            ...
            <div class="space-y-4">
                @if($isAuction)
                    @if($auctionRunning)
                        ...
                        @else
                            <a href="javascript:void(0)" onclick="openLoginModal()" class="w-full bg-neon text-dark font-black text-lg py-4 rounded-xl shadow-lg shadow-neon/20 hover:bg-neon/90 hover:scale-[1.01] transition-all flex items-center justify-center gap-2">
                ...
                @else
                    @if($product->stock > 0)
                        ...
                        <a href="javascript:void(0)" onclick="openLoginModal()" class="w-full bg-slate-800 text-slate-300 font-bold py-3 rounded-xl hover:bg-slate-700 hover:text-white transition-all flex items-center justify-center gap-2 border border-slate-700">
                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>
                            Login to Chat
                        </a>
                        @endauth
