...
33. **Tanpa Border Putih Keras di Dark Mode (Anti-Wireframe Kaku)**: Dilarang keras memakai `border-white` atau `border-slate-300` mencolok di sekeliling kontainer/kartu dalam dark mode sehingga terlihat seperti sketsa kasar/wireframe murahan. Gunakan border gelap yang menyatu dan elegan (`border-zinc-800`, `border-slate-800`, atau `border-white/10`).
